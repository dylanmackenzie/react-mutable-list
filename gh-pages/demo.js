...
var Controller = (function (_React$Component) {
  ...
  _createClass(Controller, [{
    ...
    value: function _onReorder(old, neu) {
      ...
      this.setState(function (state) {
        var tmp = _this.state.content[old];
        _this.state.content.splice(old, 1);
        _this.state.content.splice(neu, 0, tmp);
        tmp = _this.state.actives[old];
        _this.state.actives.splice(old, 1);
        _this.state.actives.splice(neu, 0, tmp);
      });
    }
  }, {
    key: '_onRemove',
    value: function _onRemove(i, e) {
      var _this2 = this;
      ...
      this.setState(function (state) {
        _this2.state.content.splice(i, 1);
        _this2.state.actives.splice(i, 1);
      });
    }
  }, {
    key: '_onInputChange',
    ...
    value: function render() {
      ...
      var lis = this.state.content.map(function (content, i) {
        var props = {
          className: 'ReactList-item',
          onClick: function onClick(e) {
            return _this3._onClick(i, e);
          },
          onRemove: function onRemove(e) {
            return _this3._onRemove(i, e);
          },
          isActive: _this3.state.actives[i],
          key: content
        };
...
},{"./list":178,"./list-item":177}],177:[function(require,module,exports){
'use strict';
...
var MutableListItem = (function (_React$Component) {
  ...
  function MutableListItem(props) {
    _classCallCheck(this, MutableListItem);

    _get(Object.getPrototypeOf(MutableListItem.prototype), 'constructor', this).call(this, props);
...
},{"classnames":2,"react/addons":3}],178:[function(require,module,exports){
'use strict';
...
var MutableListView = (function (_React$Component) {
  ...
  _createClass(MutableListView, [{
    ...
    value: function _onItemTransitionEnd(index, e) {
    ...
    value: function render() {
      ...
      var transform = undefined,
          newIndex = undefined,
          oldIndex = undefined,
          itemHeight = this.state.deletedHeight;
...
},{"classnames":2,"react/addons":3}]},{},[175]);
